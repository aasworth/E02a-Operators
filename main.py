...
def randomElement(l):
    ...
    toReturn = ''
    length = len(l)
    toReturn = l[random.randint(0, length-1)]
    return toReturn
...
def shuffleList(l):
    ...
    '''
    random.shuffle(l)       #I changed the original code used here so that I could use random.shuffle, it seemed to be the easiest way.
    return l
